    ...
    <div className="min-h-screen bg-black">
      ...
      <section className="pt-24 pb-12 bg-gradient-to-br from-black via-gray-900 to-black relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-blue-400 text-sm uppercase tracking-wide mb-2">{t('aboutCompany')}</p>
          <h1 className="text-5xl md:text-6xl font-bold text-white mb-8">{t('aboutPageTitle')}</h1>
        </div>
      </section>
      ...
      <section className="py-16 bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="group bg-white rounded-xl p-8 text-center hover:transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl">
              ...
              <div className="text-gray-600 font-medium">{t('youtubeChannels')}</div>
            </div>
            <div className="group bg-white rounded-xl p-8 text-center hover:transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl">
              ...
              <div className="text-gray-600 font-medium">{t('employees')}</div>
            </div>
            <div className="group bg-white rounded-xl p-8 text-center hover:transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl">
              ...
              <div className="text-4xl font-bold text-black mb-2">700M+</div>
              <div className="text-gray-600 font-medium">Views Per Month</div>
            </div>
            <div className="group bg-white rounded-xl p-8 text-center hover:transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl">
      ...
      <section className="py-20 bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="bg-gradient-to-br from-purple-600 to-blue-600 rounded-xl p-8 relative overflow-hidden shadow-2xl">
              ...
              <div className="relative z-10">
                <div className="w-full h-64 bg-white/10 rounded-lg flex items-center justify-center group-hover:scale-105 transition-transform duration-300">
                  <div className="w-24 h-24 bg-gradient-to-r from-yellow-400 to-red-500 rounded-full flex items-center justify-center">
            ...
            <div className="space-y-6">
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">{t('aboutLTStudioTitle')}</h2>
      ...
      <section className="py-20 bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl md:text-5xl font-bold text-white text-center mb-16">{t('whyChooseLTStudio')}</h2>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="space-y-8">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white mb-2">{t('globalReach')}</h3>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white mb-2">{t('fairCompensation')}</h3>
                  <p className="text-gray-300">
            ...
            <div className="space-y-8">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white mb-2">{t('userFriendlyPlatform')}</h3>
                  <p className="text-gray-300">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white mb-2">{t('supportiveCommunity')}</h3>
                  <p className="text-gray-300">
      ...
      <section className="py-20 bg-black">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">{t('anyQuestions')}</h2>
          <button className="group bg-gradient-to-r from-yellow-500 via-red-500 to-pink-500 hover:from-yellow-600 hover:via-red-600 hover:to-pink-600 px-8 py-4 rounded-xl text-white font-bold text-lg transition-all duration-300 transform hover:scale-105 shadow-2xl">
            <span className="flex items-center">
