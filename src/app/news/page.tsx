    ...
    <div className="min-h-screen bg-bg">
      ...
      <section className="pt-24 pb-12 bg-bg relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-5xl md:text-6xl font-bold text-ink mb-8">{t('newsTitle')}</h1>
          <p className="text-xl text-ink-dim max-w-3xl mx-auto mb-8">
            {t('newsDescription')}
          </p>
          ...
          <div className="max-w-md mx-auto">
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-3 bg-black/40 border border-cyan/25 rounded-lg text-ink placeholder-ink-dim focus:outline-none focus:border-cyan pr-12"
              />
              <button className="absolute right-3 top-1/2 transform -translate-y-1/2 text-ink-dim hover:text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2">
              <div className="neon-panel rounded-xl p-8 border border-white/20 text-center shadow-2xl">
                <div className="w-20 h-20 bg-magenta rounded-full flex items-center justify-center mx-auto mb-6">
                  <svg className="w-10 h-10 text-white" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-5 14H7v-2h7v2zm3-4H7v-2h10v2zm0-4H7V7h10v2z"/>
                  </svg>
                </div>
                <h2 className="text-3xl font-bold text-ink mb-4">{t('noContentTitle')}</h2>
                <p className="text-ink-dim mb-8 max-w-2xl mx-auto leading-relaxed">
                  {t('noContentDescription')}
                </p>
                <button className="group bg-magenta hover:from-blue-700 hover:to-purple-700 px-6 py-3 rounded-xl text-white font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg">
            ...
            <div className="space-y-8">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
                <h3 className="text-xl font-bold text-ink mb-4">{t('searchWidget')}</h3>
                <div className="relative">
                  <input
                    type="text"
              ...
              {/* Recent Posts */}
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
                <h3 className="text-xl font-bold text-ink mb-4">{t('recentPosts')}</h3>
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-ink-dim text-xs">January 1, 2024</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {/* Recent Comments */}
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
                <h3 className="text-xl font-bold text-ink mb-4">{t('recentComments')}</h3>
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
