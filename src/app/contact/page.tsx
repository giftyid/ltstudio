    ...
    <div className="min-h-screen bg-bg">
      ...
      <section className="pt-24 pb-12 bg-bg relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-5xl md:text-6xl font-bold text-ink mb-8">{t('contactPageTitle')}</h1>
      ...
      <section className="py-20 bg-bg-soft">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            <div className="group neon-panel rounded-xl p-6 text-center border border-white/20 hover:border-cyan hover:transform hover:scale-105 transition-all duration-300">
              <div className="w-12 h-12 bg-magenta rounded-lg flex items-center justify-center mx-auto mb-4">
                <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"/>
                </svg>
              </div>
              <h3 className="text-xl font-bold text-ink mb-2 group-hover:text-cyan transition-colors">{t('addressTitle')}</h3>
            ...
            <div className="group neon-panel rounded-xl p-6 text-center border border-white/20 hover:border-cyan hover:transform hover:scale-105 transition-all duration-300">
              ...
              <h3 className="text-xl font-bold text-ink mb-2 group-hover:text-cyan transition-colors">{t('openingHours')}</h3>
              <p className="text-ink-dim text-sm leading-relaxed">
                {t('openingHoursText')}
              </p>
            </div>
            ...
            <div className="group neon-panel rounded-xl p-6 text-center border border-white/20 hover:border-cyan hover:transform hover:scale-105 transition-all duration-300">
              ...
              <h3 className="text-xl font-bold text-ink mb-2 group-hover:text-cyan transition-colors">{t('emailTitle')}</h3>
              <p className="text-ink-dim text-sm leading-relaxed">
            ...
            <div className="group neon-panel rounded-xl p-6 text-center border border-white/20 hover:border-cyan hover:transform hover:scale-105 transition-all duration-300">
              ...
              <h3 className="text-xl font-bold text-ink mb-2 group-hover:text-cyan transition-colors">{t('phoneTitle')}</h3>
              <p className="text-ink-dim text-sm leading-relaxed">
                +84944.108.872
              </p>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            <div className="neon-panel rounded-lg p-8">
              <h2 className="text-3xl font-bold text-ink mb-6">{t('getStartedNowContact')}</h2>
            ...
            <div className="space-y-8">
              <div className="neon-panel rounded-lg p-8">
                <h3 className="text-2xl font-bold text-ink mb-4">{t('faqContactTitle')}</h3>
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-ink-dim">contact@ltstudio.net</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <span className="text-green-400">💬</span>
                    <span className="text-ink-dim">WhatsApp: +84944.108.872</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <span className="text-red-400">📞</span>
                    <span className="text-ink-dim">Hotline: +84944.108.872</span>
                  </div>
                </div>
              </div>
              ...
              <div className="neon-panel rounded-lg p-8">
                <h3 className="text-2xl font-bold text-ink mb-4">{t('interactiveMap')}</h3>
                <div className="w-full h-64 bg-gray-800 rounded-lg flex items-center justify-center">
                  <div className="text-center">
                    <div className="text-4xl mb-2">🗺️</div>
                    <p className="text-ink-dim">Interactive Map</p>
